...
GPT2_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    "gpt2_tied": "https://s3.amazonaws.com/models.huggingface.co/bert/gpt2-config.json",
    "gpt2_untied": "https://s3.amazonaws.com/models.huggingface.co/bert/gpt2-config.json",
...
class GPT2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # dropout prob for classification head (finetuning)
        self.clf_pdrop = clf_pdrop
        # weighting for LM objective during finetuning (lambda=0.5) from original GPT paper
